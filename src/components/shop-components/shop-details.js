...
class ShopDetails extends Component {
	...
	render() {
		...
		console.log("ShopDetails", property);
				...
				<div className="row">
					<div className="col-lg-8 col-md-12">
						<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
							...
							<label><span className="ltn__secondary-color"><i className="flaticon-pin" /></span> {property.location}</label>
							...
							<div className="property-detail-info-list section-bg-1 clearfix mb-60">
								<ul>
									...
									<li><label>Number of Bedrooms:</label> <span>{property.property_details.number_of_bedrooms}</span></li>
									<li><label>Number of Bathrooms:</label> <span>{property.property_details.number_of_bathrooms}</span></li>
									<li><label>Square Footage:</label> <span>{property.property_details.square_footage} sqft</span></li>
									<li><label>Lot Size:</label> <span>{property.property_details.lot_size} sqft</span></li>
									<li><label>Year Built:</label> <span>{property.property_details.year_built}</span></li>
								</ul>
								<ul>
							...
							<div className="ltn__property-details-gallery mb-30">
								<div className="row">
									{property.property_images.map(image => (
										<div className="col-md-6" key={image.image_id}>
											<a href={image.image_path} data-rel="lightcase:myCollection">
												<img className="mb-30" src={backendUrl+image.image_path} alt={image.image_description} />
											</a>
										</div>
									))}
								</div>
									...
									<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
										...
										<div className="product-info">
											...
											<div className="product-img-location">
												<ul>
													<li>
														<Link to="/shop"><i className="flaticon-pin" /> {property.location}</Link>
													</li>
												</ul>
											</div>
										...
										<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
											...
											<div className="product-info">
												...
												<div className="product-img-location">
													<ul>
														<li>
															<a href="product-details.html"><i className="flaticon-pin" /> {property.location}</a>
														</li>
													</ul>
												</div>
												<ul className="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
